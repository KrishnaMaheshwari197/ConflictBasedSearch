...
Colors = ['LightSeaGreen', 'lightblue', 'orange', 'bisque', 'lightcoral', 'lightgreen', 'aquamarine']
    ...
    def __init__(self, my_map, starts, goals, paths):
        ...
        for i in range(len(self.my_map)):
            for j in range(len(self.my_map[0])):
                if self.my_map[i][j]:
                    self.patches.append(Rectangle((i - 0.5, j - 0.5), 1, 1, facecolor='Wheat', edgecolor='gray'))
